        ...
        <div className="container mx-auto px-6 lg:px-8 max-w-3xl">
          <ScrollReveal>
            {insight.body && insight.body.length > 0 ? (
              ...
              <p className="text-lg text-foreground/80 leading-relaxed">{insight.content}</p>
            ) : (
        ...
        <div className="container mx-auto px-6 lg:px-8 max-w-3xl text-center">
          <ScrollReveal>
            <h2 className="font-display text-2xl md:text-3xl font-semibold text-primary mb-4">
             Got it — let’s finish this properly. The broken `<h2>` line at the end was caused by text being pasted into `className`. Here’s the **final corrected `InsightDetail.tsx` file** with all imports at the top, braces closed, and the CTA section complete:
