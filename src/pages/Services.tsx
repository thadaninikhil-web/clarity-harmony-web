...
const services = [
  ...
  { icon: PieChart, title: "Portfolio Review & Asset Allocation", desc: "We evaluate your existing portfolio for diversification, cost efficiency, risk alignment, and overlap. We then design an optimal asset allocation that balances growth with protection, tailored to your unique risk capacity." },
