...
const services = [
  { icon: Target, title: "Goal Based Investment Strategy", desc: "Every engagement starts with your life goals — retirement, children's education, home purchase, financial independence — and works backwards to design an investment strategy that makes them achievable. Every recommendation is anchored to a specific goal." },
  ...
  { icon: BarChart3, title: "Ongoing Review & Guidance", desc: "Good investing doesn't end with a document. Continuous support through regular reviews, portfolio rebalancing, life-event adjustments, and proactive guidance as your world evolves." },
];
