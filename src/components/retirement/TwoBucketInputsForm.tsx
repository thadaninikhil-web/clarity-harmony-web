...
export function TwoBucketInputsForm({ values, onChange, onReset }: Props) {
  ...
  return (
    <div className="space-y-5 text-sm">
      ...
      <section className="space-y-3">
        <h3 className="label-caps text-[10px]">Bucket setup</h3>
        <div className="space-y-3">
          <div className="space-y-1.5">
            <Label className="text-xs flex justify-between">
              <span>Years of expenses in Withdrawal bucket</span>
              <span className="tabular-nums">{values.withdrawalYears}</span>
            </Label>
            <Slider
          ...
          <div className="space-y-1.5">
            <Label className="text-xs flex justify-between"><span>Accumulation CAGR</span><span className="tabular-nums">{(values.sequenceCagr * 100).toFixed(1)}%</span></Label>
            <Slider
          ...
          <div className="space-y-1.5">
            <Label className="text-xs flex justify-between"><span>Withdrawal bucket return</span><span className="tabular-nums">{(values.withdrawalReturn * 100).toFixed(2)}%</span></Label>
