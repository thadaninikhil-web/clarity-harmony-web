...
export function BetaBanner() {
  return (
    <div className="border-b border-amber-300/60 bg-amber-50 text-amber-900">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-2 flex items-center justify-center gap-2 text-xs sm:text-sm text-center">
        ...
        <span>
          ...
          model — please consult your financial planner / advisor.
        </span>
      </div>
    </div>
  );
